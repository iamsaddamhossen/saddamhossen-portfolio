...
export function Hero() {
  ...
  return (
    <>
      <section className="relative w-full min-h-[50vh] md:min-h-[65vh] flex items-center overflow-hidden bg-gray-50">
        <Image
          src="/sh_hero.png"
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto w-full px-6 md:px-10 flex items-center">
          <div className="w-full md:w-3/5 text-left text-white flex flex-col justify-center py-16 md:py-32">
            ...
            <p className="mt-6 text-lg md:text-xl text-white/90 leading-relaxed max-w-[850px]">
              I’ve been building WordPress websites for 9+ years. I’m fully
              focused on WordPress because I love it.
            </p>
            <p className="mt-4 text-lg md:text-xl text-white/90 leading-relaxed max-w-[850px]">
              I specialize in fast, secure, scalable custom solutions that are
              easy to manage.
            </p>
